...
import xhycom
from xhycom._postprocess import _G, _ONEM, postprocess, _reconcile_velocities
...
def test_velocity_total_for_instantaneous_archive():
    ...
    np.testing.assert_allclose(out["u-vel."].values, 0.4)    # 0.3 baroclinic + 0.1 barotropic
